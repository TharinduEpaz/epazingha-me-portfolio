...
export const meta = {
  ...
  description:
    "Over the years of coding, I've seen many people fall into unhealthy habits that hurt their careers. Learn from my personal experience on maintaining good mental and physical health as a software developer.",
  image:
    "/images/blog/healthy-software-developer.png",
  tags: ["Health", "Career", "Wellness", "Lifestyle"],
  mediumUrl: "https://medium.com/@epazingha/how-to-be-a-healthy-software-developer-1c937193d515",
  linkedInUrl: "https://www.linkedin.com/in/tharindu-epasingha",
};
...
<Callout type="info">
During boredom, the mind naturally drifts from one thought to another, connecting unrelated concepts you learned throughout the day, leading to creative insights. Your mind connects the dots while your brain is in an idle state.
</Callout>
...
Solution is not a chair. Solution is movement. Your muscles need to stretch, relax, and work like they are evolved to do, otherwise your bones are getting so much unwanted force, and over time, that leads to joint pain and all kinds of other issues.
</Callout>
...
<Callout type="note">
Please be genuine; do not use people to your advantage. If you are such of person, this article is not for you (and others know that too).
</Callout>
